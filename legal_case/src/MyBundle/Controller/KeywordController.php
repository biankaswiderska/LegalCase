...
class KeywordController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $keywords = $em->getRepository('MyBundle:Keyword')->findAll();
    ...
    {
        $keyword = new Keyword();
        $form = $this->createForm('MyBundle\Form\KeywordType', $keyword);
    ...
    {
        $deleteForm = $this->createDeleteForm($keyword);
        $editForm = $this->createForm('MyBundle\Form\KeywordType', $keyword);
