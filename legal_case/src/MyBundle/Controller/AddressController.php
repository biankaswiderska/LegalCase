...
class AddressController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $addresses = $em->getRepository('MyBundle:Address')->findAll();
    ...
    {
        $address = new Address();
        $form = $this->createForm('MyBundle\Form\AddressType', $address);
    ...
    {
        $deleteForm = $this->createDeleteForm($address);
        $editForm = $this->createForm('MyBundle\Form\AddressType', $address);
